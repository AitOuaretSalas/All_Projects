...
function popularMovies() {
    axios.get('https://api.themoviedb.org/3/movie/popular?api_key=dddc509eae7e564414b6efa436aaffc1&language=en-US&page=1')
        .then((response) => {
...
function getMovies(searchText) {
    ...
    axios.get('https://api.themoviedb.org/3/search/movie?api_key=dddc509eae7e564414b6efa436aaffc1&query=' + searchText)
...
function getReviews() {
    ...
    axios.get(`https://api.themoviedb.org/3/movie/${movieId}/reviews?api_key=dddc509eae7e564414b6efa436aaffc1&language=en-US&page=1`)
...
function getMovie() {
    ...
    //test id -> 299536
    axios.get(`https://api.themoviedb.org/3/movie/${movieId}?api_key=dddc509eae7e564414b6efa436aaffc1`)
        .then((response) => {
            // https://api.themoviedb.org/3/movie/299536/reviews?api_key=5ec279387e9aa9488ef4d00b22acc451&language=en-US&page=1
            console.log(response);
...
function getTopMovies() {
    axios.get('https://api.themoviedb.org/3/movie/top_rated?api_key=dddc509eae7e564414b6efa436aaffc1&language=en-US&page=1')
        .then((response) => {
            console.log(response);
