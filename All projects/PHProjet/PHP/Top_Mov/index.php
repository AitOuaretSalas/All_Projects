...
<body>
	...
	<main role="main">
		...
		<div class="page-hd">
			...
			<h1 class="logo">
				<a href="index.php">meilleurs films notés</a>
			</h1>
			<br>
			<a href="../index.php" class="btn btn-danger ml-3">Acceuil</a>
		...
		<div class="pad max-width results-wrap">
			...
			<?php if( @$get_movies['total_results'] != 0 ) : ?>
				...
				<p class="show-images"><button class="show-images" id="js-view-images">afficher les couveteure </button></p>
				...
				<div class="single cf">
					...
					<div class="cf">
						...
						<ul class="single__info">
							...
							<li><strong>durée:</strong> <?php echo $get_movies['runtime']; ?>min</li>
