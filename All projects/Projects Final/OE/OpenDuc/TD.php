...
<html>
    ...
    <body>
        <div class="container site">
            <h1 class="text-logo"><span class="glyphicon glyphicon-book"></span> TDs <span class="glyphicon glyphicon-book"></span></h1>
            ...
            <?php
                ...
                foreach ($modules as $module) 
                {
                    ...
                    echo '<div class="row">';
                    $db = Database::connect();
                    $statement = $db->prepare('SELECT * FROM contpédag WHERE contpédag.Type = 1 AND contpédag.Module = ?');
