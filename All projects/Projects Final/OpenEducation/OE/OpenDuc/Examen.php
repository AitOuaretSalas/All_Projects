...
<html>
    ...
    <body>
        <div class="container site">
            <h1 class="text-logo"><span class="glyphicon glyphicon-book"></span> Examens <span class="glyphicon glyphicon-book"></span></h1>
            ...
            <?php
                ...
                foreach ($modules as $module) 
                {
                    ...
                    echo '<div class="row">';
                    $statement = $db->prepare('SELECT * FROM contpédag WHERE contpédag.Type = 3 AND contpédag.Module = ?');
