...
<?php include('include/headerback.php'); ?>
            ...
            <span class="menu"><a href="index.php" class="menu">les question</a></span>
            <span class="menu"><a href="dashboard.php" class="menu">reteur</a></span>
