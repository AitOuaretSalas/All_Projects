    ...
    <body>
        ...
        <a class="btn btn-primary" href="../../index.php"><span class="glyphicon glyphicon-chevron-left"></span>Reteur au Main</a>
            <div class="row">
                ...
                <h1><strong>Liste des Documents  </strong><a href="insert.php" class="btn btn-success btn-lg"><span class="glyphicon glyphicon-plus"></span> Ajouter</a></h1>
                ...
                <table class="table table-striped table-bordered">
                  ...
                  <tbody>
                      <?php
                        ...
                        $db = Database::connect();
                        $statement = $db->query('SELECT contpédag.IdPDF, contpédag.NomPDF, contpédag.AjouterPar,contpédag.NomFichePDF, modules.NomModule AS category FROM contpédag LEFT JOIN modules ON contpédag.module = modules.IdModule ORDER BY contpédag.AjouterPar DESC');
